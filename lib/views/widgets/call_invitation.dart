...
initializeCallInvitation({
  ...
  if (id.isNotEmpty) {
    ...
    print("CallInvitation initialized for user: $name, ID: $id");
  } else {
    print("Error: userName or ID is null or empty");
  }
}
...
Widget build(BuildContext context) {
  ...
  // Return your child widget or screen
  return Scaffold(
    body: Center(
      child: Text("Call Invitation Initialized"),
    ),
  );
}