...
class ChatModel {
  ...
  factory ChatModel.fromJson(Map<String, dynamic> json) => ChatModel(
    ...
    id: json["_id"],
    chatId: json["chatId"],
    senderId: _parseDynamicId(json["senderId"]),
    receiverId: _parseDynamicId(json["receiverId"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "_id": id,
    "chatId": chatId,
    "senderId": _convertDynamicId(senderId),
    "receiverId": _convertDynamicId(receiverId),
    "file": file?.toJson(),
...
dynamic _parseDynamicId(dynamic id) {
  if (id is String) return id;
  if (id is Map<String, dynamic>) return ErId.fromJson(id);
  return null;
}

dynamic _convertDynamicId(dynamic id) {
  if (id is String) return id;
  if (id is ErId) return id.toJson();
  return null;
}
