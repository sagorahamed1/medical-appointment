...
class DoctorAppointmentModelDoctorPart {
  final String? id;
  ...
  DoctorAppointmentModelDoctorPart({
    this.id,
    this.transactionId,
    this.patientId,
    this.package,
  ...
  factory DoctorAppointmentModelDoctorPart.fromJson(Map<String, dynamic> json) => DoctorAppointmentModelDoctorPart(
    id: json["_id"],
